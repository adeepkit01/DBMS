...
from items.models import UserProfile, GroupProfile, Tag, Item, subscription
...
class ItemAdmin(admin.ModelAdmin):
    ...
    list_display = ['active', 'name', 'added_by', 'added_on', 'rented_by', 'rented_on', 'tag_list', 'last_modified']
    list_display_links = ['name']
    list_editable = ['rented_by']
