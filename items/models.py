...
class subscription(models.Model):
     subuser = models.ForeignKey(User, related_name="subscription_user", verbose_name="Subscription User")
...
class Item(models.Model):
    ...
    def available(self):
        ...
        print unaware
        print now_aware
        print type(self.rented_to)
        if self.rented_to is not None :
            if self.rented_to >= now_aware:
                return False
            else:
                return True 
        else:
